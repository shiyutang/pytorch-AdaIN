...
rlaunch --gpu=1 --cpu=10 --memory=10000 -- python3 test.py --content_dir input/GTA5 --style_dir input/cityscapes_style  --alpha 0.3
```
...
CUDA_VISIBLE_DEVICES=<gpu_id> python test.py --content input/content/avril.jpg --style input/style/picasso_self_portrait.jpg,input/style/impronte_d_artista.jpg,input/style/trial.jpg,input/style/antimonocromatismo.jpg --style_interpolation_weights 1,1,1,1 --content_size 512 --style_size 512 --crop
 rlaunch --gpu=1 --cpu=10 --memory=10000 -- python3 test.py --content  /data/Projects/pytorch-AdaIN/input/GTA5/17838.png --style input/imagenet_style/ambulance/ambulance2.jpg,input/imagenet_style/ambulance/ambulance1.jpg,input/imagenet_style/ambulance/ambulance4.jpg,input/imagenet_style/ambulance/ambulance3.jpg --style_interpolation_weights 1,1,1,1 --content_size 0 --exp_tag change_size
```
...
rlaunch --gpu=1 --cpu=10 --memory=10000 -- python3 train.py --content_dir input/GTA5 --style_dir input/style
```
